        ...
        if (response.status == Location.PermissionStatus.GRANTED) {
            ...
            if (state.network_status) {
                ...
                if (status == 200) {
                    ...
                    Alert.alert("Update Failed", `An error occurred while trying to update location. Error: ${status_text}`);
                } else {
    ...
    const MapTypeButton = ({ type, text }): JSX.Element => {
        return (
            <Pressable
                ...
                style={[styles.mapTypeButton, { backgroundColor: mapType == type ? "#128cde" : "white" }]}
            >
                <Text style={[styles.mapTypeText, { color: mapType == type ? "white" : "#128cde" }]}>{text}</Text>
            </Pressable>
        );
    };
    ...
    return (
        <Card>
            ...
            >
                ...
                >
                    <Image style={styles.updateLocationImg} source={require("../../assets/updateLocation.png")} />
                </TouchableHighlight>
            </View>
